...
oooi extends, but does not replace, the OpenShift Container Platform components
listed below. Review the documentation that matches your OpenShift Container
Platform release before applying the examples in this site.
...
| Resource | Purpose |
|---|---|
| [Repository](https://github.com/cldmnky/oooi) | Source code, releases, and issue tracker |
| [Infra CR reference](configuration/infra-reference.md) | oooi API fields, defaults, and status values |
| [Examples](examples/index.md) | Generic configuration patterns |

The example names, domains, IP addresses, and registry locations on this site
are documentation values. Replace them with values appropriate for your
environment.
